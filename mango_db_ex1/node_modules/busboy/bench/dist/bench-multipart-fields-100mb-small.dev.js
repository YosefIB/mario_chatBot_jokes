...
function createMultipartBuffers(boundary, sizes) {
  ...
  for (var i = 0; i < sizes.length; ++i) {
    ...
    bufs.push(Buffer.from(["--".concat(boundary), "content-disposition: form-data; name=\"field".concat(i + 1, "\""), '', '0'.repeat(mb), ''].join('\r\n')));
  }
...
var buffers = createMultipartBuffers(boundary, new Array(100).fill(1));
var calls = {
  partBegin: 0,
  headerField: 0,
  headerValue: 0,
