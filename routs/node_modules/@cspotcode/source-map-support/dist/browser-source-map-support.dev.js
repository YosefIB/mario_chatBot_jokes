  ...
  (function e(C, J, A) {
    ...
    5: [function (C, J, A) {
      function e(a, b, h) {
        ...
        if ("number" === w) var y = 0 < a ? a >>> 0 : 0;else if ("string" === w) {
          if ("base64" === b) for (a = (a.trim ? a.trim() : a.replace(/^\s+|\s+$/g, "")).replace(L, ""); 0 !== a.length % 4;) {
            a += "=";
          }
          y = e.byteLength(a, b);
        ...
        if (e.TYPED_ARRAY_SUPPORT && "number" === typeof a.byteLength) I._set(a);else {
          var K = a;
          if (z(K) || e.isBuffer(K) || K && "object" === _typeof(K) && "number" === typeof K.length) {
            if (e.isBuffer(a)) for (b = 0; b < y; b++) {
              I[b] = a.readUInt8(b);
            } else for (b = 0; b < y; b++) {
              I[b] = (a[b] % 256 + 256) % 256;
            }
          } else if ("string" === w) I.write(a, 0, b);else if ("number" === w && !e.TYPED_ARRAY_SUPPORT && !h) for (b = 0; b < y; b++) {
            I[b] = 0;
          }
        }
        return I;
      ...
      e.concat = function (a, b) {
        ...
        var h;
        if (void 0 === b) for (h = b = 0; h < a.length; h++) {
          b += a[h].length;
        }
        var w = new e(b),
            y = 0;
        ...
        for (;;) {
          switch (a) {
            case "hex":
              ...
              for (h = a; h < b; h++) {
                a = w, w = this[h], w = 16 > w ? "0" + w.toString(16) : w.toString(16), w = a + w;
              }
            ...
            case "utf-8":
              ...
              for (h = Math.min(this.length, h); b < h; b++) {
                127 >= this[b] ? (a += g(w) + String.fromCharCode(this[b]), w = "") : w += "%" + this[b].toString(16);
              }
      ...
      e.prototype.copy = function (a, b, h, w) {
        ...
        if (w !== h && 0 !== a.length && 0 !== this.length) {
          ...
          w -= h;
          if (1E3 > w || !e.TYPED_ARRAY_SUPPORT) for (var y = 0; y < w; y++) {
            a[y + b] = this[y + h];
      ...
      e.prototype.fill = function (a, b, h) {
        ...
        if (h !== b && 0 !== this.length) {
          ...
          if ("number" === typeof a) for (; b < h; b++) {
            this[b] = a;
          } else {
            a = k(a.toString());

            for (var w = a.length; b < h; b++) {
              this[b] = a[b % w];
            }
          }
          return this;
      ...
      e.prototype.toArrayBuffer = function () {
        if ("undefined" !== typeof Uint8Array) {
          ...
          for (var a = new Uint8Array(this.length), b = 0, h = a.length; b < h; b += 1) {
            a[b] = this[b];
          }
    ...
    8: [function (C, J, A) {
      (function (e) {
        ...
        A.relative = function (c, l) {
          ...
          for (var r = q(c.split("/")), k = q(l.split("/")), u = Math.min(r.length, k.length), d = u, g = 0; g < u; g++) {
            if (r[g] !== k[g]) {
              d = g;
              break;
            }
    ...
    11: [function (C, J, A) {
      ...
      A.encode = function (p) {
        ...
        do {
          p = m & 31, m >>>= 5, 0 < m && (p |= 32), t += e.encode(p);
        } while (0 < m);
    ...
    16: [function (C, J, A) {
      ...
      e.prototype.allGeneratedPositionsFor = function (k) {
        ...
        if (0 <= d) {
          ...
          if (void 0 === k.column) for (u = n.originalLine; n && n.originalLine === u;) {
            g.push({
          ...
          } else for (k = n.originalColumn; n && n.originalLine === u && n.originalColumn == k;) {
            g.push({
              line: f.getArg(n, "generatedLine", null),
              column: f.getArg(n, "generatedColumn", null),
              lastColumn: f.getArg(n, "lastGeneratedColumn", null)
      ...
      p.prototype._parseMappings = function (k, u) {
        for (var d = 1, g = 0, n = 0, v = 0, z = 0, G = 0, D = k.length, L = 0, a = {}, b = {}, h = [], w = [], y, I, K, N, P; L < D;) {
          if (";" === k.charAt(L)) d++, L++, g = 0;else if ("," === k.charAt(L)) L++;else {
            y = new t();
            y.generatedLine = d;
      ...
      Object.defineProperty(m.prototype, "sources", {
        get: function get() {
          for (var k = [], u = 0; u < this._sections.length; u++) {
            for (var d = 0; d < this._sections[u].consumer.sources.length; d++) {
      ...
      m.prototype._parseMappings = function (k, u) {
        ...
        for (var d = 0; d < this._sections.length; d++) {
          for (var g = this._sections[d], n = g.consumer._generatedMappings, v = 0; v < n.length; v++) {
            var z = n[v],
    ...
    17: [function (C, J, A) {
      ...
      e.prototype._serializeMappings = function () {
        for (var c = 0, l = 1, q = 0, r = 0, k = 0, u = 0, d = "", g, n, v, z = this._mappings.toArray(), G = 0, D = z.length; G < D; G++) {
          n = z[G];
          g = "";
          if (n.generatedLine !== l) for (c = 0; n.generatedLine !== l;) {
            g += ";", l++;
          } else if (0 < G) {
    ...
    18: [function (C, J, A) {
      ...
      e.prototype.prepend = function (f) {
        if (Array.isArray(f)) for (var c = f.length - 1; 0 <= c; c--) {
          this.prepend(f[c]);
        } else if (f.$$$isSourceNode$$$ || "string" === typeof f) this.children.unshift(f);else throw new TypeError("Expected a SourceNode, string, or an array of SourceNodes and strings. Got " + f);
        return this;
      };

      e.prototype.walk = function (f) {
        for (var c, l = 0, q = this.children.length; l < q; l++) {
          c = this.children[l], c.$$$isSourceNode$$$ ? c.walk(f) : "" !== c && f(c, {
            source: this.source,
            line: this.line,
            column: this.column,
            name: this.name
      ...
      e.prototype.join = function (f) {
        ...
        if (0 < l) {
          ...
          for (c = 0; c < l - 1; c++) {
            q.push(this.children[c]), q.push(f);
          }
      ...
      e.prototype.walkSourceContents = function (f) {
        for (var c = 0, l = this.children.length; c < l; c++) {
          this.children[c].$$$isSourceNode$$$ && this.children[c].walkSourceContents(f);
        }
      ...
      e.prototype.toStringWithSourceMap = function (f) {
        ...
        this.walk(function (v, z) {
          ...
          for (var G = 0, D = v.length; G < D; G++) {
            10 === v.charCodeAt(G) ? (l++, q = 0, G + 1 === D ? (u = null, k = !1) : k && r.addMapping({
              source: z.source,
              original: {
                line: z.line,
                column: z.column
    ...
    19: [function (C, J, A) {
      ...
      function t(d) {
        ...
        for (var v, z = 0, G = g.length - 1; 0 <= G; G--) {
          v = g[G], "." === v ? g.splice(G, 1) : ".." === v ? z++ : 0 < z && ("" === v ? (g.splice(G + 1, z), z = 0) : (g.splice(G, 2), z--));
        }
      ...
      (function (e) {
        ...
        function r(x, B) {
          ...
          if (F) {
            var E = x.getLineNumber(),
                ...
                S = M.test;
            var V = "object" === _typeof(e) && null !== e ? e.version : "";
            M = S.call(M, V) ? 0 : 62;
        ...
        A.install = function (x) {
          ...
          if (!D) {
            ...
            x && "object" === _typeof(e) && null !== e && "function" === typeof e.on && (D = !0, d());
          }
        };
