...
function (_BaseComponent) {
  ...
  _createClass(ScrollSpy, [{
    ...
    value: function _configAfterMerge(config) {
      ...
      config.target = (0, _index.getElement)(config.target) || document.body; // TODO: v6 Only for backwards compatibility reasons. Use rootMargin only
    ...
    value: function _initializeTargetsAndObservables() {
      ...
      try {
        for (var _iterator3 = targetLinks[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
          ...
          var observableSection = _selectorEngine["default"].findOne(decodeURI(anchor.hash), this._element); // ensure that the observableSection exists & is visible
    ...
    value: function _activateParents(target) {
      ...
      try {
        for (var _iterator4 = _selectorEngine["default"].parents(target, SELECTOR_NAV_LIST_GROUP)[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
          ...
          try {
            for (var _iterator5 = _selectorEngine["default"].prev(listGroup, SELECTOR_LINK_ITEMS)[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
...
_eventHandler["default"].on(window, EVENT_LOAD_DATA_API, function () {
  ...
  try {
    for (var _iterator7 = _selectorEngine["default"].find(SELECTOR_DATA_SPY)[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
