...
function (_BaseComponent) {
  ...
  _createClass(Collapse, [{
    ...
    value: function _getFirstLevelChildren(selector) {
      var children = _selectorEngine["default"].find(CLASS_NAME_DEEPER_CHILDREN, this._config.parent); // remove children if greater depth
...
_eventHandler["default"].on(document, EVENT_CLICK_DATA_API, SELECTOR_DATA_TOGGLE, function (event) {
  ...
  try {
    for (var _iterator6 = _selectorEngine["default"].getMultipleElementsFromSelector(this)[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
