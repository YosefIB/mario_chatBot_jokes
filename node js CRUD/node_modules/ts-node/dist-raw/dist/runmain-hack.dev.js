...
var _require = require('url'),
    pathToFileURL = _require.pathToFileURL; // Hack to avoid Module.runMain on node 18.6.0
...
exports.run = function (entryPointPath) {
  Promise.resolve().then(function () {
    return _interopRequireWildcard(require("".concat(pathToFileURL(entryPointPath))));
  });
};