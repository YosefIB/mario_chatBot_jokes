...
var node_internal_modules_cjs_loader_1 = require("../dist-raw/node-internal-modules-cjs-loader");
/**
...
function classifyModule(nativeFilename, isNodeModuleType) {
  ...
  var lastDotIndex = nativeFilename.lastIndexOf('.');
  var ext = lastDotIndex >= 0 ? nativeFilename.slice(lastDotIndex) : '';
  ...
  if (isNodeModuleType) {
    var packageScope = (0, node_internal_modules_cjs_loader_1.readPackageScope)(nativeFilename);
