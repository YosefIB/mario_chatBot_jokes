...
(function (global, factory) {
  ...
  function addSection(section, mapUrl, mappings, sources, sourcesContent, names, stopLine, stopColumn) {
    ...
    for (var _i = 0; _i < len; _i++) {
      var line = decoded[_i]; // On the 0th loop, the line will already exist due to a previous section, or the line catch up
      // loop above.

      var out = _i === 0 ? mappings[lineOffset] : mappings[lineOffset + _i] = []; // On the 0th loop, the section's column offset shifts us forward. On all other lines (since the
